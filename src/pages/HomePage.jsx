...
import { Background, LinkStyled } from "./HomePageStyled";
          ...
          <section className="home-page-section">
            <div className="home-content-wrapper">
              <h1 className="home-title">
                The road to the <span className="home-title-text">depths</span>{" "}
                of the human soul
              </h1>
            ...
            <div className="home-psychologists-wrapper">
              ...
              <div>
                <p className="home-psychologists-text">Experienced psychologists</p>
